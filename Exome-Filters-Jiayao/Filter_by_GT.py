...
def GetOptions():
	parser = OptionParser()
	parser.add_option('-v','--vcf',dest = 'VCF', metavar = 'VCF', help = 'vcf file to process.')
	parser.add_option('-p','--ped',dest = 'PED', metavar = 'PED', help = 'pedigree file needed.')
	parser.add_option('-d','--dir',dest = 'DIR', metavar = 'DIR', help = 'directory to save output files.')
