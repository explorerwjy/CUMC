...
Custome_info = ['Func.refGene', 'Gene.refGene', 'GeneDetail.refGene', 'ExonicFunc.refGene', 'AAChange.refGene', 'MLEAC', 'MLEAF', 'gnomAD_genome_ALL', 'gnomAD_exome_ALL',
                'esp6500siv2_all', '1000g2015aug_all', 'ExAC_ALL', 'MetaSVM_pred', 'CADD13_PHRED', 'MCAP', 'avsnp147', 'Annotation', 'GeneticModels', 'ModelScore', 'Compounds', ]
