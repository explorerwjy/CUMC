...
def GetOptions():
    ...
    parser.add_argument('-p', '--ped', type=str, required=True, help='Pedigree file contains family relationship of samples in csv file.')
    parser.add_argument('-b', '--bam', type=str, required=True, help='File contains bam locations. ')
    parser.add_argument('-o', '--output', type=str, help='Output 1 of this script, Input variant list for IGV. ')
    parser.add_argument('-s', '--script', type=str, help='Output 2 of this script, Script to run GATK Bamout. ')
